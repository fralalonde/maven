...
public class DownloaderTest {
    ...
    public void setUp()
        ...
        Path rootDir = testDir.resolve("root");
        downloadFile = rootDir.resolve("file");
        Path remoteFile = testDir.resolve("remoteFile");
        Files.write(remoteFile, Collections.singletonList("sometext"));
    ...
    public void testDownload()
        ...
        assertEquals("sometext",
                String.join("", Files.readAllLines(downloadFile)));
    }
}
