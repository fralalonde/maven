...
public class ComparableVersionTest {
    ...
    private static final String[] VERSIONS_QUALIFIER = { "1-alpha2snapshot", "1-alpha2", "1-alpha-123", "1-beta-2",
            "1-beta123", "1-m2", "1-m11", "1-rc", "1-cr2",
    ...
    private static final String[] VERSIONS_NUMBER = { "2.0", "2-1", "2.0.a", "2.0.0.a", "2.0.2", "2.0.123", "2.1.0",
            ...
            "2.2", "2.123", "11.a2", "11.a11", "11.b2", "11.b11", "11.m2", "11.m11", "11", "11.a", "11b", "11c",
            "11m" };
    ...
    private void checkVersionsEqual(String v1, String v2) {
        ...
        assertEquals(c1.compareTo(c2), 0, "expected " + v1 + " == " + v2);
        assertEquals(c2.compareTo(c1), 0, "expected " + v2 + " == " + v1);
        assertEquals(c2.hashCode(), c1.hashCode(), "expected same hashcode for " + v1 + " and " + v2);
        assertEquals(c2, c1, "expected " + v1 + ".equals( " + v2 + " )");
        assertEquals(c1, c2, "expected " + v2 + ".equals( " + v1 + " )");
    }
