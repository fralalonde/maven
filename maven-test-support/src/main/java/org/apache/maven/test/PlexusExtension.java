...
/**
 * This is a slightly modified version of the original plexus class available at
 * https://raw.githubusercontent.com/codehaus-plexus/plexus-containers/master/plexus-container-default/
 * src/main/java/org/codehaus/plexus/PlexusTestCase.java in order to migrate the
 * tests to JUnit 4.
 *
...
public class PlexusExtension implements BeforeEachCallback, AfterEachCallback {
    ...
    /**
     * Allow the retrieval of a container configuration that is based on the name of
     * the test class being run. So if you have a test class called org.foo.FunTest,
     * then this will produce a resource name of org/foo/FunTest.xml which would be
     * used to configure the Plexus container before running your test.
     *
