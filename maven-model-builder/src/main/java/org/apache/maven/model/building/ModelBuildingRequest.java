...
public interface ModelBuildingRequest {
    ...
    /**
     * Gets the file model to build (with profile activation). If not set, model
     * source will be used to load file model.
     *
    ...
    /**
     * @deprecated setting the rawModel has no effect, instead the fileModel of
     *             phase one will be set
     */
    @Deprecated
