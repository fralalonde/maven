...
public interface SettingsBuildingResult {
     ...
     * that only problems of severity {@link Problem.Severity#WARNING} and below are
     * reported here. Problems with a higher severity level cause the settings
     * builder to fail with a {@link SettingsBuildingException}.
     *
