...
public class DefaultSettingsValidator
    ...
    @Override
    public void validate(Settings settings, ProblemCollector problems) {
    ...
    private void validateRepositories(ProblemCollector problems, List<Repository> repositories, String prefix) {
     ...
     * </ul>
     */
    private static boolean validateNotNull(ProblemCollector problems, String fieldName, Object object,
            String sourceHint) {
        if (object != null) {
            return true;
        }
