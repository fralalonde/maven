...
class PluginDependencyResolutionListener
    ...
    private final ArtifactFilter coreFilter;

    private final LinkedList<Artifact> coreArtifacts = new LinkedList<>();

    private Artifact wagonProvider;

    private final Map<Artifact, Object> bannedArtifacts = new IdentityHashMap<>();
